...
class Artist extends CI_Controller {
    ...
    public function searchArtist()
    {
		...
		$request_str = 'http://developer.echonest.com/api/v4/artist/search?api_key='. $this->apiKey .'&format=json';
		
		if (!is_null($artist) && $artist!='') $request_str = $request_str . '&name=' . $artist;
